...
const CarCard = ({ car }) => {
  return (
    <div class="container h-[30vw] border  w-[45vh]">
      <div class="h-full w-full bg-gray-900 shadow-lg rounded-xl p-6">
        <div class="flex flex-col ">
          <div class="relative  overflow-hidden !h-[14vw] w-[20vw] mb-10">
            ...
            <img src={car?.imgurl} alt="Just a flower" class=" object-cover h-full w-full rounded-2xl" />
          </div>
          <div class="flex-auto justify-evenly  ">
            <div class="flex flex-wrap ">
              <div class="w-full flex-none text-sm flex items-center text-gray-600">
                ...
                <span class="text-gray-400 whitespace-nowrap mr-3">{car.rating}</span><span class="mr-2 text-gray-400">{car.country}</span>
              </div>
              <div class="flex items-center w-full justify-between min-w-0 ">
                <h2 class="text-lg mr-auto cursor-pointer text-gray-200 hover:text-purple-500 truncate ">{car.name}</h2>
                <div class="flex items-center bg-green-400 text-white text-xs px-2 py-1 ml-3 rounded-lg">
                  Available</div>
              </div>
            </div>
            <div class="text-lg text-white font-semibold mt-3">{car.price}</div>
            <div class="lg:flex  py-4  text-sm text-gray-600">
              <div class="flex-1 inline-flex items-center mb-3">
                <span class="text-secondary whitespace-nowrap mr-3">Features</span>
                <div class="cursor-pointer text-gray-400 ">
                  <span class="hover:text-purple-500 p-1 py-0">4 People</span>
                  <span class="hover:text-purple-500 p-1 py-0">Hybrid</span>
                  <span class="hover:text-purple-500 p-1 py-0">6.1km/1 ltr</span>
                  <span class="hover:text-purple-500 p-1 py-0">Automatic</span>
                </div>
              </div>
            </div>
